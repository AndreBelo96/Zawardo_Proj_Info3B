...
public class Constant {
    ...
    public static final float MOVE_IDLE =  11f * 0.2f;
    ...
    public static final float MOVE_VEL_PER_PIXEL_X = TILE_WIDHT/2 / MOVE_TIME;
    public static final float MOVE_VEL_PER_PIXEL_Y = PLAYER_MOVEMENT_Y / MOVE_TIME;
}
